# Script Documentation  https://betterprogramming.pub/color-your-captions-streamlining-live-transcriptions-with-diart-and-openais-whisper-6203350234ef
# Original Gist https://gist.github.com/juanmc2005/ed6413e697e176cb36a149d8c40a3a5b
import logging
import os
import sys
import traceback
...
# Define your MQTT broker and topic
...
source.stream.pipe(
    ...
    on_next=lambda transcription: (rich.print(transcription), client.publish(topic, transcription)),
...
# Disconnect from the MQTT broker after finishing transcription and diarization
client.disconnect()